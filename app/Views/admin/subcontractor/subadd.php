                        ...
                        <div class="panel-body">
                           <form action="<?=BASE; ?>Subcontractor/sub_insert" method="POST"  enctype="multipart/form-data" class="col-sm-12">
                            ...
                            <div class="row">
                              <div class="form-group col-sm-6">
                                 ...
                                 <input type="text" name="subcompanyName" id="subcompanyName"class="form-control" placeholder="Enter Sub Contractor Company Name " value="<?= set_value('subcompanyName'); ?>" >
                                 <div class="text-danger"><?php if(isset($error['subcompanyName'])) {echo $error['subcompanyName']; } ?></div>
                              </div>
                              <div class="form-group col-sm-6">
                                 <label>Company Owner Name </label>
                                 <input type="text" name="ownername" id="ownername"class="form-control" placeholder="Enter Sub Contractor Company Owner Name " value="<?= set_value('ownername'); ?>" >
                           ...
                           <div class="row">
                              <div class="form-group col-sm-6">
                                 ...
                                 <input type="text" name="cellno" id="cellno"class="form-control" placeholder="Enter Sub Contactor Cell Number" value="<?= set_value('cellno'); ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  >
                              ...
                              <div class="form-group col-sm-6">
                               ...
                               <div class="form-group col-sm-6">
                                 ...
                                 <input type="text"  name="Sub_con_per_cellno" id="Sub_con_per_cellno" class="form-control" placeholder="Enter Sub Contractor Contact person Cell Number"  value="<?= set_value('con_per_cellno'); ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                              </div>
                           </div>
                           <div class="row">
                           <div class="form-group col-sm-6">
...
<script>
    $(document).ready(function () {
        $("#submit").click(function () {
            var selectedDropdown = $('#companyname');
            if (selectedDropdown.val() === '0') {
                alert("Please Select Comapny Name");
                $('#companyname').focus();
