                           ...
                           <div class="btn-group" style= >
                              ...
                              <ul class="dropdown-menu exp-drop" role="menu">
                                 ...
                                 <!-- <li> 
                                    ...
                                    <img src="<?=BASE; ?>assets/dist/img/csv.png" width="24" alt="logo"> CSV</a>
                                 </li>
                                 <li>
                                    <a href="#" onclick="$('#dataTableExample1').tableExport({type:'txt',escape:'false'});"> 
                                    <img src="<?=BASE; ?>assets/dist/img/txt.png" width="24" alt="logo"> TXT</a>
                                 </li> -->
                                 <li class="divider"></li>
                                 <li>
                                 ...
                                 <!-- <li>
                                    ...
                                    <img src="<?=BASE; ?>assets/dist/img/word.png" width="24" alt="logo"> Word</a>
                                 </li>
                                 <li>
                                    <a href="#" onclick="$('#dataTableExample1').tableExport({type:'powerpoint',escape:'false'});"> 
                                    <img src="<?=BASE; ?>assets/dist/img/ppt.png" width="24" alt="logo"> PowerPoint</a>
                                 </li>
                                 <li class="divider"></li>
                                 <li>
                                    <a href="#" onclick="$('#dataTableExample1').tableExport({type:'png',escape:'false'});"> 
                                    <img src="<?=BASE; ?>assets/dist/img/png.png" width="24" alt="logo"> PNG</a>
                                 </li>
                                 <li>
                                    <a href="#" onclick="$('#dataTableExample1').tableExport({type:'pdf',pdfFontSize:'7',escape:'false'});"> 
                                    <img src="<?=BASE; ?>assets/dist/img/pdf.png" width="24" alt="logo"> PDF</a>
                                 </li> -->
                              </ul>
                           </div>
                           <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
